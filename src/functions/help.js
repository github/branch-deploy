...
export async function help(octokit, context, reactionId, inputs) {
  ...
  let commit_verification_message
  ...
  let draft_permitted_targets_message
  ...
  let enforced_deployment_order_message
