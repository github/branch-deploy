...
| auto_merge | no | true | If set to “false”, GitHub does not attempt to automatically merge the default branch into the requested ref even if requested ref is behind the default branch. |
